...
public class Season {
    ...
    public Season(int id, int hotel_id, String start_date, String finish_date,String season_type, double price_parameter) {
        this.id = id;
    ...
    public double getPrice_parameter() {return price_parameter;}
